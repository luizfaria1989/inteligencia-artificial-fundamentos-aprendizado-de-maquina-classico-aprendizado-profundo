...
\documentclass[
    10pt,            % Tamanho da fonte do corpo do texto
...
% ===================================================================
\begin{document}
% Adiciona entradas do glossário
\input{glossario.tex}
...
\begin{epigrafe}
	...
	\begin{flushright}
		...
		\textit{``Non ha l'ottimo artista alcun concetto\\
		Ch'un marmo solo in sé non circoscriva\\
		Col suo soverchio; e solo a quello arriva\\
		La man che ubbidisce all'intelletto.''}\\
		\vspace{0.5cm}
		% Tradução em Português
		``O melhor artista não tem nenhum conceito\\
		Que um único mármore não encerre em si\\
		Com o seu excesso; e lá só chega\\
		A mão que obedece ao intelecto.''\\
		\vspace{0.5cm}
		(Michelangelo Buonarroti, \textit{Rime}, Soneto 151)
	\end{flushright}
\end{epigrafe}
...
\include{capitulos/parte-III-pilares/cap-xx-metricas-regressao}
\include{capitulos/parte-III-pilares/cap-xx-perda-classificacao}
\include{capitulos/parte-III-pilares/cap-xx-metricas-classificacao}
\include{capitulos/parte-III-pilares/cap-xx-perdas-especificas}
\include{capitulos/parte-III-pilares/cap-xx-metricas-especificas}
...
\appendix
\part{Apêndices}
\include{capitulos/apendices/demonstracoes-funcoes-de-perda}
