...
\textbf{Algumas Aplicações do RMSProp em Otimização de Redes Neurais} \index{Aplicações práticas! RMSProp}
\vspace{1em}
...
\textbf{Algumas Aplicações do Adam em Otimização de Redes Neurais} \index{Aplicações práticas! Adaptive Moment Esitmation (Adam)}
\vspace{1em}
