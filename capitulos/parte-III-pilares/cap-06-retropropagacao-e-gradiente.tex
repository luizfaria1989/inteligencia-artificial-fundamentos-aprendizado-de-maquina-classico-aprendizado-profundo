...
\subsubsection*{Algumas Aplicações do AdaGrad em Otimização de Redes Neurais}%
...
\subsubsection{Algumas Aplicações do RMSProp em Otimização de Redes Neurais}%
...
\subsubsection{Algumas Aplicações do Adam em Otimização de Redes Neurais}%
...
\subsubsection*{Algumas Aplicações do NAdam em Otimização de Redes Neurais}%
...
\subsubsection*{Algumas Aplicações do ADamW em Otimização de Redes Neurais}%
