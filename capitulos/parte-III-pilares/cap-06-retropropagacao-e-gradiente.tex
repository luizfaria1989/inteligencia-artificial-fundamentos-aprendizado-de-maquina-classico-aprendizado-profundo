...
\subsection{Comparativo de Otimizadores Clássicos} \index{Comparativos!Otimizadores Clássicos}
...
\textbf{Algumas Aplicações do AdaGrad em Otimização de Redes Neurais} \index{Aplicações práticas! Adpative Gradient Algorithm (AdaGrad)}
\vspace{1em}
...
\textbf{Algumas Aplicações do NAdam em Otimização de Redes Neurais} \index{Aplicações práticas! NAdam}
\vspace{1em}
...
\textbf{Algumas Aplicações do ADamW em Otimização de Redes Neurais} \index{Aplicações práticas! ADamW}
\vspace{1em}
...
\subsection{Comparativo dos Otimizadores Modernos} \index{Comparativos!Otimizadores Modernos}
