...
\begin{equation}
    \text{Swish}(z_i) = z_i \cdot \sigma(z_i) = z_i \frac{1}{1 + e^{-z_i}}
    \label{eq:EquacaoSwish}
\end{equation}
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \label{fig:GraficoSwish}
\end{figure}

\begin{equation}
    \frac{d}{dz_i} [\text{Swish}](z_i) = \text{Swish}(z_i) + \sigma(z_i)(1 - \text{Swish}(z_i))
    \label{eq:DerivadaSwish}
\end{equation}
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \label{fig:GraficoSwishDerivada}
\end{figure}
