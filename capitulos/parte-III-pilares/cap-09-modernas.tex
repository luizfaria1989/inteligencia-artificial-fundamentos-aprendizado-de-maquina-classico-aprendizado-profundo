...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        ...
        \addplot[black, thick, domain=-3.5:3.5, samples=100, smooth] 
...
\subsubsection*{Características da Guassian Error Linear Unit}
...
\begin{equacaodestaque}{Derivada Gaussian Error Linear Unit}
    \frac{d}{dx_j} [\mathcal{A}_{\text{GELU}}](x_j) = \Phi(x_j) + x_j\phi(x_j)
    \label{eq:gelu-derivada}
\end{equacaodestaque}

\begin{equacaodestaque}{Derivada Completa Gaussian Error Linear Unit}
    \frac{d}{dx} [\mathcal{A}_{\text{GELU}}](x_j) = \Phi(x_j) + \frac{x_j}{\sqrt{2\pi}} e^{-\frac{x_j^2}{2}}
...
\subsubsection*{Algumas Aplicações da Gaussian Error Linear Unit em Redes Neurais}
...
\subsection{Swish}%
\index{Funções de Ativação!Swish}

\begin{equacaodestaque}{Swish}
    \mathcal{A}_{\text{Swish}}(x_j) = x_j \cdot \sigma(x_j) = x_j \frac{1}{1 + e^{-x_j}}
    \label{eq:swish}
\end{equacaodestaque}
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        ...
        \addplot[black, thick, domain=-5.5:5.5, samples=100, smooth] 
            {x / (1 + exp(-x))};
        \addlegendentry{Swish($x_j$) = $x_j \cdot \sigma(x_j)$}
...
\subsubsection*{Características da Swish}
...
\begin{equacaodestaque}{Derivada Swish}
    \frac{d}{dx_j} [\mathcal{A}_{\text{Swish}}](x_j) = \text{Swish}(x_j) + \sigma(x_j)(1 - \text{Swish}(x_j))
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        ...
        \addplot[black, thick, domain=-5.5:5.5, samples=101, smooth] 
            { (x / (1 + exp(-x))) + (1 / (1 + exp(-x))) * (1 - (x / (1 + exp(-x)))) };
        \addlegendentry{$\text{Swish}'(x_j) = \text{Swish}(x_j) + \sigma(x_j)(1-\text{Swish}(x_j))$}
...
\subsubsection*{Algumas Aplicações da Swish em Redes Neurais}
...
\begin{equacaodestaque}{Hard-Swish}
    \mathcal{A}_{\text{h-Swish}}(x_j) = x_j \cdot \frac{\text{ReLU6}(x_j + 3)}{6}
    \label{eq:h-swish}
\end{equacaodestaque}
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        ...
        \addplot[black, thick, domain=-5.5:5.5, samples=100, smooth] 
            {x * min(max(0, x + 3), 6) / 6};
        \addlegendentry{h-Swish($x_j$) = $x_j \cdot \frac{\text{ReLU6}(x_j + 3)}{6}$}
...
\subsubsection*{Características da Hard Swish}
...
\begin{equacaodestaque}{Derivada Hard-Swish}
    \frac{d}{dx_j} [\mathcal{A}_{\text{h-Swish}}](x_j) = \begin{cases} 0 & \text{se } x_j \le -3 \\ \frac{2x_j + 3}{6} & \text{se } -3 < x_j < 3 \\ 1 & \text{se } x_j \ge 3 \end{cases}
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        ...
        \addplot[black, thick, domain=-5.5:5.5, samples=101, smooth] 
            { (x <= -3) ? 0 : ((x >= 3) ? 1 : ( (2*x + 3) / 6 )) };
        \addlegendentry{$\text{h-Swish}'(x_j)$}
...
\subsubsection*{Algumas Aplicações da Hard Swish em Redes Neurais}
...
\subsection{Mish}%
\index{Funções de Ativação!Mish}

\begin{equacaodestaque}{Mish}
    \mathcal{A}_{\text{Mish}}(x_j) = x_j \cdot \tanh(\text{softplus}(x_j)) = x_j \cdot \tanh(\ln(1 + e^{x_j}))
    \label{eq:mish}
\end{equacaodestaque}
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        ...
        \addplot[black, thick, domain=-5.5:5.5, samples=100, smooth] 
            {x * tanh(ln(1 + exp(x)))};
        \addlegendentry{Mish($x_j$) = $x_j \cdot \tanh(\text{softplus}(x_j))$}
...
\subsubsection*{Características da Mish}
...
\begin{equacaodestaque}{Derivada Mish}
    \frac{d}{dx_j} [\mathcal{A}_{\text{Mish}}](x_j) = \tanh(\omega) + x_j \sigma(x_j) \text{sech}^2(\omega) \\
    \text{onde } \omega = \text{softplus}(x_j) \text{ e } \sigma(x_j) \text{ é a função sigmoide.}
...
\subsubsection*{Algumas Aplicações da Mish em Redes Neurais}
\vspace{1em}
...
\begin{equacaodestaque}{Hard-Mish}
    \mathcal{A}_{\text{h-Mish}}(x_j) = \frac{x_j}{2} \cdot \min(\max(x_j + 2, 0), 2)
    \label{eq:h-mish}
\end{equacaodestaque}
...
\subsubsection*{Características da Hard Mish}
...
\begin{equacaodestaque}{Derivada Hard-Mish}
    \frac{d}{dx_j} [\mathcal{A}_{\text{h-Mish}}](x_j) = \begin{cases} 0 & \text{se } x_j \le -2 \\ x_j + 1 & \text{se } -2 < x_j < 0 \\ 1 & \text{se } x_j \ge 0 \end{cases}
...
\subsubsection*{Algumas Aplicações da Hard Mish em Redes Neurais}
...
\begin{equacaodestaque}{Softmax}
    \mathcal{A}_{\text{Softmax}}(x_j) = \frac{e^{x_j}}{\sum_{j=1}^{K} e^{z_j}}
    \label{eq:softmax}
\end{equacaodestaque}
...
\begin{equacaodestaque}{Derivada Softmax}
    \frac{\partial [\mathcal{A}_{\text{Softmax}}](x_j)}{\partial z_j} = 
    \begin{cases} 
      \text{Softmax}(x_j)(1 - \text{Softmax}(x_j)) & \text{se } i = j \\
      - \text{Softmax}(x_j)\text{Softmax}(z_j) & \text{se } i \neq j
    \end{cases}
...
\begin{equacaodestaque}{Identidade}
    \mathcal{A}_{\text{Linear}}(x_j) = x_j
    \label{eq:linear}
\end{equacaodestaque}
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        ...
        \addplot[black, thick, domain=-5.5:5.5, samples=10, smooth] 
            {x};
        \addlegendentry{Linear($x_j$) = $x_j$}
...
\begin{equacaodestaque}{Derivada Identidade}
    \frac{d}{dx_j} [\mathcal{A}_{\text{Linear}}](x_j) = 1
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        ...
        \addplot[black, thick, domain=-5.5:5.5, samples=10, smooth] 
            {1};
        \addlegendentry{$\text{Linear}'(x_j) = 1$}
...
\begin{equacaodestaque}{Softplus}
    \mathcal{A}_{\text{Softplus}}(x_j) = \ln(1 + e^{x_j})
    \label{eq:softplus}
\end{equacaodestaque}
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        ...
        \addplot[black, thick, domain=-5.5:5.5, samples=100, smooth] 
            {ln(1 + exp(x))};
        \addlegendentry{Softplus($x_j$) = $\ln(1 + e^{x_j})$}
...
\begin{equacaodestaque}{Derivada Softplus}
    \frac{d}{dx_j} [\mathcal{A}_{\text{Softplus}}](x_j) = \frac{e^{x_j}}{1 + e^{x_j}} = \frac{1}{1 + e^{-x_j}} = \sigma(x_j)
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        ...
        \addplot[black, thick, domain=-5.5:5.5, samples=101, smooth] 
            { 1 / (1 + exp(-x)) };
        \addlegendentry{$\text{Softplus}'(x_j) = \sigma(x_j)$}
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        ...
        \addplot[black, thick, domain=-4.5:2.5, samples=100, smooth] 
            {exp(x)};
        \addlegendentry{Exp($x_j$) = $e^{x_j}$}
...
\begin{equacaodestaque}{Derivada Exponencial}
    \frac{d}{dx_j} [\mathcal{A}_{\text{Exp}}](x_j) = e^{x_j}
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        ...
        \addplot[black, thick, domain=-4.5:2.5, samples=101, smooth] 
            {exp(x)};
        \addlegendentry{$\text{Exp}'(x_j) = e^{x_j}$}
