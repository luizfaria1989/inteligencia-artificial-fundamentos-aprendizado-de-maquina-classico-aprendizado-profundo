...
\begin{description}[style=sameline, leftmargin=1.5em, font=\bfseries\color{black}] 
    \item[Predição de hashtags em e-comerces (Comércio):] \textcite{Camargo_2021} estudam sobre modelos como BiLSTM e BERT podem predizer hashtags em português brasileiro para sites de e-comerce, os autores aplicam uma tarefa de classificação utilizando a CCE esparsa com o intuito de refinar o BERT e sua habilidade de predizer palavras.
    \item[Classificação de grãos de arroz (Agronomia):] \textcite{xia2025improvedpurefullyconnected} desenvolvem uma rede neural totalmente conectada para classificação de grãos de arroz, como se tratava de um problema de classificação multiclasse, os autores optam pela CCE esparsa como função de perda.
