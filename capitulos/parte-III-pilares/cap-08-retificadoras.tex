...
\begin{equacaodestaque}{\textit{Rectified Linear Unit} (\textit{ReLU})}
    \text{ReLU}(y_j) = \begin{cases}y_j, & \text{se } y_j > 0 \\0, & \text{se } y_j \leq 0\end{cases} \quad \text{ou} \quad \text{ReLU}(y_j) = \max(0, y_j)
    \label{eq:relu}
\end{equacaodestaque}
...
\begin{equacaodestaque}{\textit{Rectified Linear Unit} (\textit{ReLU} Derivada)}
    \frac{d}{dy_j} [ReLU](y_j) = \begin{cases}1, & \text{se } y_j > 0 \\0, & \text{se } y_j \leqslant 0 \end{cases}
...
\begin{equacaodestaque}{\textit{Leaky ReLU} (\textit{LReLU})}
    \text{LReLU}(y_j) = \begin{cases}y_j, & \text{se } y_j \ge 0 \\ \alpha \cdot y_j, & \text{se } y_j < 0\end{cases} \quad \text{ou} \quad \text{LReLU}(y_j) = \max(0, \alpha y_j)
    \label{eq:leaky-relu}
\end{equacaodestaque}
...
\begin{equacaodestaque}{\textit{Leaky ReLU} (\textit{LReLU} Derivada)}
    \frac{d}{dy_j} [LReLU](y_j) = \begin{cases}1, & \text{se } y_j > 0 \\ \alpha, & \text{se } y_j \leqslant  0 \end{cases}
...
\begin{equacaodestaque}{\textit{Parametric ReLU} (\textit{PReLU})}
    \text{PReLU}(y_j) = \begin{cases}y_j, & \text{se } y_j \ge 0 \\ \alpha_i \cdot y_j, & \text{se } y_j < 0\end{cases} \quad \text{ou} \quad \text{PReLU}(y_j) = \max(0, \alpha y_j)
    \label{eq:prelu}
\end{equacaodestaque}
...
\begin{equacaodestaque}{\textit{Parametric ReLU} (\textit{PReLU} Derivada)}
    \frac{d}{dy_j} [PReLU](y_j) = \begin{cases}1, & \text{se } y_j > 0 \\ \alpha_i, & \text{se } y_j \le 0 \end{cases}
...
\begin{equacaodestaque}{\textit{Randomized Leaky ReLU} (\textit{RReLU})}
    \text{RReLU}(y_j) = \begin{cases} y_j, & \text{se } y_j > 0 \\ \alpha_i y_j, & \text{se } y_j \leq 0 \end{cases} \quad \text{ou} \quad \text{RReLU}(y_j) = \max(0, \alpha y_j)
    \label{eq:rrelu}
\end{equacaodestaque}
...
\begin{equacaodestaque}{\textit{Randomized Leaky ReLU} (\textit{RReLU}) Derivada}
    \frac{d}{dy_j} [\text{RReLU}](y_j) = \begin{cases}1, & \text{se } y_j > 0 \\ \alpha_i, & \text{se } y_j \leqslant  0 \end{cases}
...
\begin{equacaodestaque}{\textit{Exponential Linear Unit} (\textit{ELU})}
    \text{ELU}(y_j) = \begin{cases}y_j, & \text{se } y_j \ge 0 \\ \alpha \cdot (e^{y_j} - 1), & \text{se } y_j < 0\end{cases}
    \label{eq:elu}
\end{equacaodestaque}
...
\begin{equacaodestaque}{\textit{Exponential Linear Unit} (\textit{ELU}) Derivada}
    \frac{d}{dy_j} [ELU](y_j) = \begin{cases}1, & \text{se } y_j > 0 \\ \alpha \cdot e^{y_j}, & \text{se } y_j \le 0 \end{cases}
...
\begin{equacaodestaque}{\textit{Scaled Exponential Linear Unit} (\textit{SELU})}
    \text{SELU}(y_j) = \lambda \begin{cases}y_j, & \text{se } y_j > 0 \\ \alpha \cdot (e^{y_j} - 1), & \text{se } y_j \le 0\end{cases} \quad \text{ou} \quad \text{SELU}(y_j) = \lambda \text{ELU}(y_j)
    \label{eq:selu}
\end{equacaodestaque}
...
\begin{equacaodestaque}{\textit{Scaled Exponential Linear Unit} (\textit{SELU}) Derivada}
    \frac{d}{dy_j} [SELU](y_j) = \lambda \begin{cases}1, & \text{se } y_j > 0 \\ \alpha \cdot e^{y_j}, & \text{se } y_j \le 0\end{cases}
...
\begin{equacaodestaque}{\textit{Noisy ReLU} (\textit{NReLU}) para o \textit{Backward Pass}}
    \frac{d}{dy_j}[\text{NReLU}](y_j) = \begin{cases} 
        1 & \text{se } y_j > 0 \\
        0 & \text{se } y_j \le 0
    \end{cases}
