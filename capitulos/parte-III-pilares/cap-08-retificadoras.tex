...
Essa equação criada por Householder, lembra bastante a expressão da função ReLU, a qual é denotada pelas Equações~\ref{eq:relu}.
...
\subsubsection*{Aplicações da Rectified Linear Unit}%
...
\subsubsection*{Leaky ReLU na pesquisa de \parencite{LeakyReLUArticle}}
...
\subsubsection*{Aplicações da Leaky ReLU}%
...
\subsubsection*{Parametric ReLU na pesquisa de \parencite{PReLUArticle}}
...
\subsubsection*{Aplicações da Parametric ReLU}%
...
\subsubsection*{Randomized Leaky ReLU na pesquisa de \parencite{XuRReLU}}
...
\subsubsection*{Aplicações da Randomized Leaky ReLU}%
...
\subsubsection*{Exponential Linear Unit na pesquisa de \parencite{ELUArticle}}
...
\subsubsection*{Aplicações da Exponential Linear Unit}%
...
\subsubsection*{Scaled Exponential Linear Unit na pesquisa de \parencite{SELUArticle}}
...
\subsubsection*{Aplicações da Scaled Exponential Linear Unit}%
...
\subsubsection*{Noisy ReLU na pesquisa de \parencite{Nair2010}}
...
\subsubsection*{Aplicações da Noisy ReLU}%
