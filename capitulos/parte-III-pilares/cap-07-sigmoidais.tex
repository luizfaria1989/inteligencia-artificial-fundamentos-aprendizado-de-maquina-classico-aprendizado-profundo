...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        ...
        \addplot[black, thick, domain=-8:8, samples=100] {1/(1+exp(-x))};
    \end{axis}
    \end{tikzpicture}
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        ...
        \addplot[black, thick, domain=-8:8, samples=100] {exp(-x)/((1+exp(-x))^2)};
        \end{axis}
    \end{tikzpicture}
...
\subsubsection*{Algumas Aplicações da Sigmoide Logística em Redes Neurais}%
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        ...
        \addplot[black, thick, domain=-5:5, samples=100] {tanh(x)};
        \end{axis}
    \end{tikzpicture}
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        ...
        \addplot[black, thick, domain=-5:5, samples=100] {1-(tanh(x))^2};
        \end{axis}
    \end{tikzpicture}
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        ...
        \addplot[black, thick, domain=-10:10, samples=101] {x / (1 + abs(x))};
        \end{axis}
    \end{tikzpicture}
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        ...
        \addplot[black, thick, domain=-10:10, samples=101] {1/((1+abs(x))^2)};
        \end{axis}
    \end{tikzpicture}
