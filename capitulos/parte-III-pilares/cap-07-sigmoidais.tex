...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        ...
        \addplot[black, thick, domain=-8:8, samples=100] {0.8623(x) + 0.3011};
        \end{axis}
    \end{tikzpicture}
    \caption{Conjunto de pontos dispostos no plano cartesiano.}%
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[black, thick, domain=-2:10, samples=150] {wilson_sigmoid(a, theta, x)};
        \end{axis}
    \end{tikzpicture}
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        ...
        \addplot[black, thick, domain=-8:0] {0};
        \addplot[black, thick, domain=0:8] {1};
        \addplot[only marks, mark=o, mark size=1.5pt, black, fill=white] coordinates {(0,0)};
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        ...
        \addplot[black, very thick, domain=-8:8, samples=100] {1/(1+exp(-x))};
    \end{axis}
    \end{tikzpicture}
    \caption{Função de ativação sigmoide logística.}%
    \label{fig:sigmoide}
    \fonte{O autor (2026).}
\end{figure}

\subsubsection*{Características da Sigmoide Logística}
...
\subsubsection*{Gradiente da sigmoide logística}
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        ...
        \addplot[black, very thick, domain=-8:8, samples=100] {exp(-x)/((1+exp(-x))^2)};
        \end{axis}
    \end{tikzpicture}
    \caption{Derivada da função de ativação sigmoide logística.}%
    \label{fig:sigmoide-derivada}
    \fonte{O autor (2026).}
\end{figure}

\subsubsection*{Aplicações da Sigmoide Logística}%
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        ...
        \addplot[black, very thick, domain=-5:5, samples=100] {tanh(x)};
        \end{axis}
    \end{tikzpicture}
    \caption{Função de ativação tangente hiperbólica (tanh).}%
    \label{fig:tanh}
    \fonte{O autor (2026).}
\end{figure}

\subsubsection*{Características da Tangente Hiperbólica}
...
\subsubsection*{Gradiente da tangente hiperbólica}
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        ...
        \addplot[black, very thick, domain=-5:5, samples=100] {1-(tanh(x))^2};
        \end{axis}
    \end{tikzpicture}
    \caption{Derivada da função de ativação tangente hiperbólica (tanh).}%
...
\subsubsection*{Aplicações da Tangente Hiperbólica em Redes Neurais}%
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        ...
        \addplot[black, very thick, domain=-14:14, samples=101] {x / (1 + abs(x))};
        \end{axis}
    \end{tikzpicture}
...
\subsubsection*{Características da Softsign}
...
\subsubsection*{Gradiente da softsign}
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        ...
        \addplot[black, very thick, domain=-14:14, samples=101] {1/((1+abs(x))^2)};
        \end{axis}
    \end{tikzpicture}
...
\subsubsection*{Aplicações da Softsign em Redes Neurais}%
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        ...
        \addplot[color = black, very thick, domain=-5:5, samples=100] {
            (x < -3) * 0 +
            (x >= -3 && x <= 3) * (x/6 + 0.5) +
            (x > 3) * 1
        };
...
\subsubsection*{Características da Hard Sigmoid}
...
\subsubsection*{Gradiente da perda de hard-sigmoid}
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        ...
        \draw[dashed, black] (axis cs:-3, 0) -- (axis cs:-3, 1/6);
        \draw[dashed, black] (axis cs:3, 0) -- (axis cs:3, 1/6);
        \end{axis}
    \end{tikzpicture}
...
\subsubsection*{Características da Hard Tanh}
...
\subsubsection*{Gradiente da perda de hard-tanh}
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        ...
        \draw[dashed, black] (axis cs:-1, 0) -- (axis cs:-1, 1);
        \draw[dashed, black] (axis cs:1, 0) -- (axis cs:1, 1);
        \end{axis}
    \end{tikzpicture}
...
\subsubsection*{Aplicações das Funções Hard Sigmoid e Hard Tanh em Redes Neurais}%
...
\subsubsection*{Indo Além das Funções de Ativação Sigmoidais}
