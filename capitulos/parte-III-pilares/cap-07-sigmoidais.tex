...
\begin{equacaodestaque}{Tangente Hiperbólica (tanh)}
    \tanh(y_j) = \frac{\sinh(y_j)}{\cosh(y_j)} = \frac{e^y_j - e^{-y_j}}{e^y_j + e^{-y_j}}
    \label{eq:tanh}
\end{equacaodestaque}
...
\begin{equacaodestaque}{Tangente Hiperbólica (tanh) Derivada}
    \frac{d}{dy_j}[\tanh](y_j) = \text{sech}^2(y_j)
...
\begin{equacaodestaque}{Tangente Hiperbólica (tanh) Derivada Recursivamente}
    \frac{d}{dy_j}[\tanh](y_j) = 1 - \tanh^2(y_j)
...
\begin{equacaodestaque}{\textit{Softsign}}
    \text{softsign}(y_j) = \frac{y_j}{1 + |y_j|}
    \label{eq:softsign}
\end{equacaodestaque}
...
\begin{equacaodestaque}{\textit{Softsign} Derivada}
    \frac{d}{dy_j}[\text{softsign}](y_j) = \frac{1}{(1 + |y_j|)^2}
...
\begin{equacaodestaque}{\textit{Hard Sigmoid}}
        \text{hard sigmoid}(y_j) = \begin{cases} 0 & \text{se } y_j < -3 \\ y_j/6 + 0.5 & \text{se } -3 \le y_j \le 3 \\ 1 & \text{se } y_j > 3 \end{cases}
...
\begin{equacaodestaque}{\textit{Hard Sigmoid} Derivada}
        \frac{d}{dy_j}[\text{hard sigmoid}](y_j) = \begin{cases} 0 & \text{se } y_j < -3 \\ 1/6 & \text{se } -3 < y_j < 3 \\ 0 & \text{se } y_j > 3 \end{cases}
...
\begin{equacaodestaque}{\textit{Hard Tanh}}
        \text{hard tanh}(y_j) = \begin{cases} -1 & \text{se } y_j < -1 \\ y_j & \text{se } -1 \le y_j \le 1 \\ 1 & \text{se } y_j > 1 \end{cases}
    \label{eq:hard-tanh}
\end{equacaodestaque}
...
\begin{equacaodestaque}{\textit{Hard Tanh} Derivada}
        \frac{d}{dy_j}[\text{hard tanh}](y_j) = \begin{cases} 0 & \text{se } y_j < -1 \\ 1 & \text{se } -1 < y_j < 1 \\ 0 & \text{se } y_j > 1 \end{cases}
