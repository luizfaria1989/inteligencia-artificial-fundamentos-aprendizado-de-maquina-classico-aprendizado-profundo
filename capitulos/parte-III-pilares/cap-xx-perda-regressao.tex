...
\begin{figure}[h!]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \node[anchor=north, font=\tiny, text=black] at (axis cs:2, -0.1) {Mínimo em $\hat{y}=2$};
                
                % Destaque visual da assimetria
                \node[font=\tiny, text=black!70, anchor=west] at (axis cs:0.5, 3) {Punição Severa ($\hat{y} \to 0$)};
            \end{axis}
        \end{tikzpicture}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \node[anchor=north, font=\tiny, text=black] at (axis cs:10, -0.1) {Mínimo em $\hat{y}=10$};
            \end{axis}
        \end{tikzpicture}
    ...
    \caption{Visualização da Perda Gamma. Note a penalidade assimétrica: a curva sobe abruptamente à esquerda (subestimativa) e suavemente à direita (superestimativa).}%
...
\begin{description}[style=sameline, leftmargin=1.5em, font=\bfseries\color{black}] 
    \item[Continuidade, suavidade e diferenciabilidade:] (ver Apêndice~\ref{ap:deducoes-gamma-loss})
    \item[Convexidade:] (ver Apêndice~\ref{ap:deducoes-gamma-loss})
    \item[Robustez:] (ver Apêndice~\ref{ap:deducoes-gamma-loss})
\end{description}
