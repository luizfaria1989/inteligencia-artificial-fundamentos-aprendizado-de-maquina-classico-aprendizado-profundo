...
Em seguida, é possível ver representação gráfica da derivada da Equação~\ref{eq:msle-derivada} na Figura~\ref{fig:msle-derivada}. Seguindo a mesma regra das outras figuras apresentadas até agora, na Figura~\ref{fig:msle-derivada-2d}, a esquerda, está a representação em duas dimensões, enquanto na Figura~\ref{fig:msle-derivada-3d}, a direita, está a representação da superfície no espaço.
