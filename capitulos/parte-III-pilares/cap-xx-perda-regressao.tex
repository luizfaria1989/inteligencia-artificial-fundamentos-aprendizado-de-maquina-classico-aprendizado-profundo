...
A distribuição de Poisson é dada pela Equação~\ref{eq:poisson-distribution-pmf}, em que o espaço amostral é conjunto de inteiros não-negativos. \textcite{GeneralizedLinearModels} aponta que essa distribuição não possui uma limite superior nos valores que podem ser observados, diferente da distribuição Normal.
