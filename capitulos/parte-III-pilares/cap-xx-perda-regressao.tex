...
Em \textit{Generalized Linear Models} \textcite{GeneralizedLinearModels} cita alguns exemplos em que essa distribuição pode ser aplicada:

\begin{description}[style=sameline, leftmargin=1.5em, font=\bfseries\color{black}]  
    \item[Reivindicações de seguro de carro:] 
    \item[Tempos de coágulo do sangue:] 
    \item[Modelando dados de chuvas usando dois modelos lineares generalizados:] 
    \item[Taxa de desenvolvimento de Drosophila melanogaster:] 
\end{description}
