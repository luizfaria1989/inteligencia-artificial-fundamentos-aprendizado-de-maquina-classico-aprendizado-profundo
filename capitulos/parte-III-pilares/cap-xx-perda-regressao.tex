...
Para isso, essa seção busca explicar a função de perda erro quadrático médio logarítmico, que possui uma tendência de penalizar mais as subestimação. Serão vistos seus gráficos, sua fórmula e aplicações, bem como nas outras funções vistas até o momento.
...
Visto isso, é possível começar a seção explicando primeiro a perda quantílica.
