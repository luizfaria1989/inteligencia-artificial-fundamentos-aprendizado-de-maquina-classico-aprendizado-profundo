...
\begin{figure}[h!]
    ...
    \caption{Visualizações do erro quadrático médio (\textit{MSE}) em duas e em três dimensões.}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                width=\linewidth,  
                height=7cm,
                title={(a) Gradiente vs. Erro (Visão 2D)},
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                width=\linewidth,
                height=7cm,
                title={(b) Superfície do Gradiente (Visão 3D)},
                xlabel={$y$ (Real)},
                ylabel={$\hat{y}$ (Previsto)},
...
\begin{figure}[h!]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                width=\linewidth,  
                height=7cm,
                title={(a) Perda vs. Erro (Visão 2D)},
    ...
    % --- Legenda e Fonte da Figura Principal ---
    \caption{Visualizações do erro absoluto médio (\textit{MAE}) em duas e em três dimensões.}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                width=\linewidth,  
                height=7cm,
                title={(a) Gradiente vs. Valor Previsto (Visão 2D)},
                xlabel={Valor Previsto ($\hat{y}$)},
                ylabel={Gradiente ($\frac{\partial L}{\partial \hat{y}}$)},
                axis lines=middle,
                grid=major,
